...
graph LR
	...
	DASHBOARD --> VISUALCONDO --> VISUALPAGAM
	DASHBOARD --> GESTISCONDO --> GESTISRESID --> GESTISPAGAM

	subgraph Amministratore
		GESTISCONDO[Gestisci condomini]
		GESTISRESID[Gestisci residenti]
		GESTISPAGAM[Gestisci pagamenti]
	end
	subgraph Utente
		VISUALCONDO[Visualizza condomini]
		VISUALPAGAM[Visualizza pagamenti]
	end
</div>
</div>
