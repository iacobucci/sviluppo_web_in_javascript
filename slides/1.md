...
Gli *attori*, utenti e amministratori, saranno interfacciati con una **pagina web**, che comunica con un **server** che gestisce i dati. La pagina web sarà accessibile da ogni **browser** abbastanza aggiornato.
