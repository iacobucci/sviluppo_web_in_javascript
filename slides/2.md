...
Gli oggetti in Javascript hanno un **prototype** che è un oggetto che contiene le proprietà e i metodi che l'oggetto eredita.
...
Sono un tipo di dato *primitivo*, **immutabili**, con metodi (non sono `"object"`!).
