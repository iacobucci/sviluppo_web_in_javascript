...
Possiamo servire i files statici in `public`

---

### Middleware

Express introduce il pattern *middleware*, che semplifica il flusso di richieste e risposte.
...
Proviamo la richiesta *GET* con il browser:
